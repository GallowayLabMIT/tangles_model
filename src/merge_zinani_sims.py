...
if __name__ == '__main__':
    i = 0
    with h5py.File('../output/modeling_paper/modeling_model_zinani_tangles_sims.h5','w') as outfile:
        for f in pathlib.Path('../output/modeling_paper').glob('fig_zinani_sims*.h5'):
