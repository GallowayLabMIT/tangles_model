...
if __name__ == '__main__':
    i = 0
    with h5py.File('../output/modeling_paper/modeling_spacing_sweep_summaries.h5','w') as outfile:
        for f in pathlib.Path('../output/modeling_paper').glob('fig_base_model_spacing_sims*.h5'):
