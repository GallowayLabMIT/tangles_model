...
%\usepackage[scaled=.96,lf]{XCharter}
%\linespread{1.04}
\usepackage[backend=biber,style=nature,backref=true,url=false]{biblatex} %author-year for submission to the journal, nature style for viewing
%\hyphenpenalty=750
\usepackage{cleveref}
...
\titleformat{\subsection}[display]{\bfseries\large}{}{0em}{}
\titleformat{\subsubsection}[display]{\itshape}{}{0em}{}
...
\begin{figure}
    ...
    \caption{Supercoiling-dependent feedback induces syntax-specific expression profiles.
        ...
        \subref{fig:reporter_output_by_spacing_fold_induction} Reporter output is shown as a function of intergene spacing (\(\Delta x\)) at five different induction levels. Reporter output is normalized by dividing mRNA counts by a constant value (250 mRNAs). See also \Cref{fig:top:supp_dynamics_details}.
...
\begin{figure}[htbp]
    ...
    \caption{Supercoiling-dependent feedback induces dynamic coupling and altered variance between genes.
        ...
        See also \Cref{fig:top:supp_dynamics_details}.
    }
...
\begin{figure}[htbp]
    ...
    \caption{Burst dynamics vary in different models of DNA supercoiling.
        ...
        See also \Cref{fig:top:supp_dynamics_details,fig:top:supp_perturb_energy_well,fig:top:supp_perturb_nucleosomes}
    }
...
\begin{figure}[htbp]
    ...
    See also \Cref{fig:top:supp_toggles}
...
\begin{figure}[htbp]
    ...
    \caption{Supercoiling-mediated feedback supports robust transcriptional coordination within the zebrafish segmentation clock circuit.
        ...
        \subref{fig:zinani_mRNA_behavior} Example simulations of \textit{her1} and \textit{her7} mRNA levels are shown as a function of gene syntax and topoisomerase activity.
...
\begin{figure}[htbp]
    ...
    \caption{Related to \Cref{fig:top:her1_her7}.
       \subref{fig:supp:zinani_matlab_mRNA} Using the authors' MATLAB implementation of the model in \textcite{zinaniPairingSegmentationClock2021}, we simulated ensembles of 10,000 runs in order to compare to our simulation work. Unlike our implementation, which does not contain extra delays not due to polymerase motion and stalling, the original model uses a fixed mRNA production delay time of 9 minutes and a fixed protein production delay time of 1 minute. Example runs of the original model are shown. The transcript-coupled case shows correlated but relatively aperiodic behavior.
        ...
        \subref{fig:supp:zinani_alpha_oscillation_amplitude} The mean oscillation amplitude is shown for the gene unpaired and gene paired cases with intragenic topoisomerase relaxation. The gene paired case still shows an increase in average oscillation amplitude.
