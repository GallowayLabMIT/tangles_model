...
\begin{figure}[htbp]
    ...
    \phantomsubcaption\label{fig:toggle_cartoon} %TODO: include the actual distance in bp's between the nodes
    ...
    \subref{fig:toggle_stable_frac_n_2.0} For a selected Hill coefficient of \(n = 2.0\), the stability of the four starting states of the system are plotted as a function of time.
...
%TODO: do we want to call out any of the plots in {fig:toggle_vs_topo_rate} explicitly?


\begin{figure}[htbp]
    \centering
    {\includegraphics{figures/modeling_paper/fig_4.pdf}
    \phantomsubcaption\label{fig:toggle_tunability_cartoon}% For here, include a cartoon of how the mRNA pool size is affected by the mRNA degradation rate.
...
\begin{figure}[htbp]
    \centering
    {\includegraphics{figures/modeling_paper/fig_5.pdf}
